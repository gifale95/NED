"""Use the trained fwRF ecoding models to predict the brain responses for the
NSD, ImageNet or THINGS images.
...
parser.add_argument('--imageset', type=str, default='nsd') # ['nsd', 'things', 'imagenet_val']
...
if args.roi in ['lateral', 'ventral']:
	model_dir_1 = os.path.join(args.ned_dir, 'encoding_models', 'modality-fmri',
		'training_dataset-nsd', 'model-fwrf', 'encoding_models_weights',
		'weights_'+subj_roi_dir_1+'.pt')
	model_dir_2 = os.path.join(args.ned_dir, 'encoding_models', 'modality-fmri',
		'training_dataset-nsd', 'model-fwrf', 'encoding_models_weights',
		'weights_'+subj_roi_dir_2+'.pt')
else:
	model_dir = os.path.join(args.ned_dir, 'encoding_models', 'modality-fmri',
		'training_dataset-nsd', 'model-fwrf', 'encoding_models_weights',
...
save_dir = os.path.join(args.ned_dir, 'synthetic_neural_responses',
	'modality-fmri', 'training_dataset-nsd', 'model-fwrf', 'imageset-'+
	args.imageset)
